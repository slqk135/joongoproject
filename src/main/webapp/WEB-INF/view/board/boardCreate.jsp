		...
		<div id="container">
			...
			<div class="category">
				<div class="inner">
					...
					<form name="frm" action="boardCreateSave" method="post" modelAttribute="BoardCommand" enctype="multipart/form-data">
					<table>
						...
						<tr >
							<td colspan="2" style="height:20pt;">
								<input type="text" id="boardTitle" name="boardTitle" maxlength="50" style="width:100%; height:100%; font-size:13pt; "placeholder="제목을 입력해주세요."/>
							</td>
						</tr>
						<tr>
							<td colspan="2">
						...
						<tr>
							<td colspan="2" style="height:20pt;">
								<input type="text" id="goodsName" name="goodsName" style="width:200pt; height:100%; font-size:13pt;" placeholder="상품명을입력해주세요"/><br/>
							</td>
						</tr>
						<tr>
						<tr>
						...
						<tr>
							<td colspan="2" style="height:20pt;">
								<input type="text" id="goodsPrice" name="goodsPrice" style="width:100pt; height:100%; font-size:13pt;" placeholder="0"/>원<br/>
							</td>
						</tr>
						<tr>
							<td colspan="2">
						...
						<tr>
							<td colspan="2">
								<label><input type="checkbox" id="goodsState" name="goodsState" value="new"/>미개봉 제품</label>
								<label><input type="checkbox" id="goodsState" name="goodsState" value="old" checked/>중고제품</label>
							</td>
						</tr>
						<tr>
							<td colspan="2">
						...
						<tr>
							<td>
								<b>업로드 이미지</b><input type="file" name="goodsImg" id="goodsImg"/>
							</td>
						</tr>
            			<tr>
            				<td colspan="2">
            					<textarea id="boardContent" name="boardContent" style="width:100%; height:350px; ">
					...
					<input type="hidden" id="boardState" name="boardState" value="N"/>
					</form>
				</div>
			</div>
