	...
	function onAjaxError (){
		alert("[클릭]사진 업로더할 서버URL셋팅이 필요합니다.-onAjaxError");
	}
 	...
 	function callFileUploader (){
 		...
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : "/board/file_uploader.jsp",	//샘플 URL입니다.
 	        sCallback : "/smarteditor2-2.8.2.3/sample/photo_uploader/callback.html",	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
